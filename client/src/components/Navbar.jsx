...
function Navbar() {
    ...
    <nav className="bg-zinc-800 text-white shadow-md">
        <div className="max-w-full mx-auto px-6 py-4 flex items-center justify-between">
            <Link to={"/"}>
            <h1 to="/" className="text-2xl font-bold hover:text-blue-600 transition-colors">Tasks Manager</h1>
            </Link>
                ...
                {isAuthenticated ? (
                    ...
                    <>
                        <li className="hover:text-white transition-colors">
                            <Link to="/login" className="bg-blue-600 px-4 py-1 rounded-sm hover:bg-green-600">Login</Link>
                        </li>
                        <li className="hover:text-white transition-colors">
                            <Link to="/register" className="bg-blue-600 px-4 py-1 rounded-sm hover:bg-orange-600">Register</Link>
                        </li>
                    </>
                )}
            </ul>
